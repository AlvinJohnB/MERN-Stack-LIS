    ...
    <Page size={[612, 396]} style={styles.page}>
      ...
      <View style={styles.footer} fixed={true}>
        <View style={styles.footerContainer}>
          <Text style={[styles.content, styles.textCenter]}>Performed By</Text>
          <Text style={[styles.content, styles.textCenter]}>PERFORMER</Text>
        </View>

        <View style={styles.footerContainer}>
          <Text style={[styles.content, styles.textCenter]}>RMT</Text>
          <Text style={[styles.content, styles.textCenter]}>REGISTERED MEDICAL TECHNOLOGIST</Text>
          <Text style={[styles.content, styles.textCenter]}>License No.: _____</Text>
        </View>

        <View style={styles.footerContainer}>
          <Text style={[styles.content, styles.textCenter]}>Patho</Text>
          <Text style={[styles.content, styles.textCenter]}>PATHOLOGIST</Text>
          <Text style={[styles.content, styles.textCenter]}>License No: </Text>
        </View>
      </View> */}
    </Page>
  </Document>
